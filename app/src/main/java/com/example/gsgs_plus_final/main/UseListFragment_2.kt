...
class UseListFragment_2 : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val v =inflater.inflate(R.layout.fragment_use_list2, container, false)
        ...
        val list = v.findViewById<RecyclerView>(R.id.used_list_view)
